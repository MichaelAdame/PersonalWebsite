            ...
            <div className="font-normal lg:pt-4 pb-8 lg:col-span-2 text-base sm:w-9/12 md:w-10/12 mx-auto  lg:mx-0">
              <motion.div variants={stagger}>
                <motion.p variants={fadeInUp} className="mb-4">
                  Hello! I&apos;m Michael, a software developer based in Houston, Tx🤠.
                </motion.p>
                <motion.p variants={fadeInUp} className="mb-4">
                  I’m a full stack developer working on all things front end and back. I enjoy staying up to date with the latest technologies. 
                  Whether it's a brand new project or a fix on an old one, my goal is to develop the best solutions possible. 
                </motion.p>
                <motion.p variants={fadeInUp} className="mb-4">
                  ...
                  focused on leveraging Amazon Web Services wide range of tools to clients. I aspire toward a career that will allow
                ...
                <motion.p variants={fadeInUp} className="mb-4">
                  When I’m not in front of a computer screen, I am probably exploring the city, shredding guitar, or trying my hand at a
                  new dinner recipe.
                </motion.p>
                <motion.p variants={fadeInUp} className="mb-4">
